 ...
 */
final class Version20240205105522 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE question (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, question VARCHAR(255) NOT NULL, publication_date DATETIME NOT NULL, validated VARCHAR(255) NOT NULL, country VARCHAR(255) NOT NULL, views VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
